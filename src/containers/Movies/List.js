...
import Layout from '../../components/Movies/List';
...
class MoviesListContainer extends Component {
  ...
  */
   ...
   */
  render = () => {
    const { listFlat, listPaginated, pagination, meta, data, addItemToFavouriteList, favourites, navigation } = this.props;
...
const mapStateToProps = (state) => ({
  data: state,
  listFlat: state.movies.listFlat || [],
